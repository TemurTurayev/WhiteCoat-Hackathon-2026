...
Usage:
    python WhiteCoat.devSeg.py --test_dir <path_to_test_images> --model WhiteCoat.devSegModel.pth

Output: WhiteCoat.dev masks/ folder with binary PNG masks
"""
import argparse
import torch
import cv2
...
def main():
    ...
    parser.add_argument("--model", default="WhiteCoat.devSegModel.pth", help="Path to model weights")
    parser.add_argument("--output_dir", default="WhiteCoat.dev masks", help="Output masks folder")

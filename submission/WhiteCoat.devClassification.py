...
Loads trained ensemble model and generates Excel predictions.

Usage:
    python WhiteCoat.devClassification.py --test_dir <path_to_test_images> --model_dir <path_to_models>
...
def main():
    ...
    parser.add_argument("--model_dir", default=".", help="Path to folder with model weights")
